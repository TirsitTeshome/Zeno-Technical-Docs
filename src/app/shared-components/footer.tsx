...
export default function Footer() {
  ...
  <li className="flex items-center gap-2">
    ...
    <a href="mailto:zenoai@gmail.com">
      zenoai@gmail.com
    </a>
  </li>
  <li className="flex items-center gap-2">
    <FaPhone className="text-cyan-200 scale-x-[-1]" />
    <a href="tel:+254766784320">
      +254766784320
    </a>
  </li>
</ul>
      ...
      <div className="border-t border-gray-600 mt-8 sm:mt-10 md:mt-15 pt-4 sm:pt-6 text-center text-gray-400 text-sm sm:text-base md:text-[15px] max-w-screen-2xl mx-auto w-full">
